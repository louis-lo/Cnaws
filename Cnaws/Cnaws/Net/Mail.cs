...
namespace Cnaws.Net
{
    ...
    public sealed class MailAttachments
    {
    ...
    public sealed class MailMessage
    {
        ...
        private List<string> _Recipients;//收件人
        ...
        public MailMessage()
        {
            _Recipients = new List<string>();//收件人列表
    ...
    public sealed class SmtpClient
    {
        ...
        {
            using (SmtpServerHelper helper = new SmtpServerHelper())
            {
        ...
        private sealed class SmtpServerHelper : IDisposable
        {
            ...
            /// SMTP错误代码哈希表
            /// </summary>
            private static Hashtable ErrCodeHT;
            /// <summary>
            /// SMTP正确代码哈希表
            /// </summary>
            private static Hashtable RightCodeHT;
            ...
            /// SMTP回应代码哈希表
            /// </summary>
            static SmtpServerHelper()
            {
                ErrCodeHT = new Hashtable();
            ...
            {
                //建立文件流对象
                using (FileStream FileStr = new FileStream(FilePath, FileMode.Open, FileAccess.Read, FileShare.Read))
                {
            ...
            {
                return SendEmail(smtpServer, port, false, string.Empty, string.Empty, mailMessage);
            }
            ...
            private bool SendEmail(string smtpServer, int port, bool ESmtp, string username, string password, MailMessage mailMessage)
            {
                ...
                {//不需要身份认证
                    ...
                    if (!Dialog(SendBufferstr, string.Empty))
                        return false;
                }
                ...
                {
                    SendBuffer[i] = "RCPT TO:<" + mailMessage.Recipients[i] + ">" + CRLF;
                }
                ...
                else
                {
                    SendBufferstr += "To:=?" + mailMessage.Charset.ToUpper() + "?B?" +
                     Base64Encode(mailMessage.Recipients[0]) + "?=" + "<" + mailMessage.Recipients[0] + ">" + CRLF;
                }
