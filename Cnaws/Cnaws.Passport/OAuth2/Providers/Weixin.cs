...
{
    internal sealed class Weixin : OAuth2Provider
    {
        private const string API_URL = "https://api.weixin.qq.com/";
        public Weixin(OAuth2ProviderOptions options)
            : base(options)
        {
            base.Scope.Add("snsapi_userinfo");
        }
        ...
        public override bool ApprovalPrompt
        {
            get { return false; }
        }
        ...
        {
            get { return "https://open.weixin.qq.com/connect/oauth2/authorize"; }
        }
