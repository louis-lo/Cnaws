...
namespace Cnaws.Web.Templates.Parser
{
    ...
    public class Parser
    {
        ...
        {
            collection.Clear();
            //collection.Add(new UndefinedParser());
            collection.Add(new NullParser());
            collection.Add(new BooleanParser());
            collection.Add(new NumberParser());
            collection.Add(new ElseParser());
            collection.Add(new EndParser());
            collection.Add(new ClrParser());
            ...
            //collection.Add(new UrlParser());
            //collection.Add(new ResParser());
            collection.Add(new ArrayParser());
            collection.Add(new JsonParser());
