...
{
    public sealed class ProductBrand : ManagementController
    {
        ...
        public void List(int categoryId = -1, string sort = "", string order = "", int page = 1)
        {
            ...
            {
                if (CheckRight())
                    SetResult(M.ProductBrand.GetPageEx(DataSource, categoryId, sort, order, page, 10));
            }
        }
        public void Add()
        {
